...
$conn.ConnectionString = "Data Source=$instance;Initial Catalog=$database;User ID=$sqluser;Password=$sqlpass;MultipleActiveResultSets=True;Application Name=Powershell"

GenerateDBScript $conn "$database" "C:\Users\Public\Export"
